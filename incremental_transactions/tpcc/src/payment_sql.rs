...
> {
    let (circuit, streams) = Runtime::init_circuit(cconf, |circuit| {
        ...
        let stream3610: Stream<_, WSet<Tup3<Option<i32>, Option<i32>, Option<Decimal>>>> =
            stream451.stream_join(
                &stream492,
                move |t_5: &Tup1<i32>,
        ...
        let stream927: Stream<_, WSet<Tup3<Option<i32>, Option<i32>, Option<Decimal>>>> = stream166
            .filter(
        ...
        let stream5388: Stream<_, WSet<Tup3<Option<i32>, Option<i32>, Option<Decimal>>>> =
            stream1038.stream_join(
                &stream1079,
